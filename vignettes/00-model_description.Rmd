...
$$
X_{t+1} = X_t + r \left( 1 - \beta(t) ~ \alpha ~ \text{e}^{X_t} \right) + \varepsilon
\text{ ,}
$$
...
$\beta(t)$ is the effect of deteriorating plant health on aphid growth as a function
of time: $\beta(t) = \exp( \zeta ~ t )$, where $\zeta$ indicates the speed at which
plant health deteriorates through time.
