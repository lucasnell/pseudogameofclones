...
$$\begin{align}
    ...
    \sigma_\varepsilon &\sim \text{N} ( \theta_1, ~ \theta_2^{~2} ) \texttt{T[0,]} \\
\end{align}$$
...
$$\begin{align}
    ...
    \rho &\sim \text{N}(\theta_3, ~ \theta_4^{~2}) \\
    \sigma_\rho &\sim \text{N}(\theta_5, ~ \theta_6^{~2}) \texttt{T[0,]} \\
\end{align}$$
