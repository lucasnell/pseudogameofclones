...
namespace model_pass_sigma_epsilon_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_pass_sigma_epsilon");
    ...
    reader.add_event(20, 9, "restart", "model_pass_sigma_epsilon");
    reader.add_event(113, 102, "end", "model_pass_sigma_epsilon");
    return reader;
}
...
#include <meta_header.hpp>
 class model_pass_sigma_epsilon : public prob_grad {
private:
    int n_ts;
    int n_obs;
    vector<int> n_per;
    ...
    vector<double> theta;
public:
    model_pass_sigma_epsilon(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_pass_sigma_epsilon_namespace::model_pass_sigma_epsilon";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "sigma_epsilon", "double", context__.to_vec());
            sigma_epsilon = double(0);
            ...
            current_statement_begin__ = 34;
            check_greater_or_equal(function__,"sigma_epsilon",sigma_epsilon,0);
            current_statement_begin__ = 37;
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_pass_sigma_epsilon_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_pass_sigma_epsilon";
    }
...
typedef model_pass_sigma_epsilon_namespace::model_pass_sigma_epsilon stan_model;
