...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(21, 12, "end", "/chunks/helpers.stan");
    reader.add_event(21, 10, "restart", "model_no_within_alpha");
    reader.add_event(136, 125, "end", "model_no_within_alpha");
    return reader;
}
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= n_ts; ++j) {
                ...
                stan::math::assign(alpha_hat,inv_logit((phi + (sigma_phi_l * get_base1(Z_alpha_l,get_base1(L,j,"L",1),"Z_alpha_l",1)))));
