...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(29, 9, "restart", "model_no_among_alpha");
    reader.add_event(152, 132, "end", "model_no_among_alpha");
    return reader;
}
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= n_ts; ++j) {
                ...
                stan::math::assign(alpha_hat,inv_logit((phi + (hat_sigma_phi_p * get_base1(Z_alpha_p,j,"Z_alpha_p",1)))));
            ...
            lp_accum__.add(normal_log<propto__>(X_hat, X_hat_pred, hat_sigma_epsilon));
