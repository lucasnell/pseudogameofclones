...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(100, 100, "end", "model_all_lines_plants");
    return reader;
}
...
ricker(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& X,
           ...
           const T4__& a_,
           const T5__& sigma_,
           const Eigen::Matrix<T6__, Eigen::Dynamic,1>& Z_X, std::ostream* pstream__) {
    ...
    try {
        ...
        stan::model::assign(X_out, 
                    ...
                    add(add(stan::model::rvalue(X, stan::model::cons_list(stan::model::index_min_max(start, (end - 1)), stan::model::nil_index_list()), "X"),multiply(r_,subtract(1,multiply(a_,exp(stan::model::rvalue(X, stan::model::cons_list(stan::model::index_min_max(start, (end - 1)), stan::model::nil_index_list()), "X")))))),multiply(sigma_,Z_X)), 
...
struct ricker_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& X,
           ...
           const T4__& a_,
           const T5__& sigma_,
           const Eigen::Matrix<T6__, Eigen::Dynamic,1>& Z_X, std::ostream* pstream__) const {
        return ricker(X, start, end, r_, a_, sigma_, Z_X, pstream__);
    }
};
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("Z_X", "(n_obs - n_ts)", (n_obs - n_ts));
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("Z_X", "(n_obs - n_ts)", (n_obs - n_ts));
        context__.validate_dims("initialization", "Z_X", "vector_d", context__.to_vec((n_obs - n_ts)));
        vector_d Z_X(static_cast<Eigen::VectorXd::Index>((n_obs - n_ts)));
        for (int j1__ = 0U; j1__ < (n_obs - n_ts); ++j1__)
            Z_X(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_unconstrain(Z_X);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<T__,Eigen::Dynamic,1>  Z_X;
            (void) Z_X;  // dummy to suppress unused var warning
            if (jacobian__)
                Z_X = in__.vector_constrain((n_obs - n_ts),lp__);
            else
                Z_X = in__.vector_constrain((n_obs - n_ts));
            ...
            for (int j = 1; j <= n_ts; ++j) {
                ...
                stan::math::assign(r_,exp((rho + (sigma_rho * get_base1(Z_r,get_base1(L,j,"L",1),"Z_r",1)))));
                ...
                stan::model::assign(X_pred, 
                            ...
                            ricker(X,start,end,r_,a_,sigma_epsilon,stan::model::rvalue(Z_X, stan::model::cons_list(stan::model::index_min_max(((start + 1) - j), (end - j)), stan::model::nil_index_list()), "Z_X"), pstream__), 
            ...
            lp_accum__.add(normal_log<propto__>(Z_X, 0, 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vector_d Z_X = in__.vector_constrain((n_obs - n_ts));
