...
namespace model_one_alpha_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_one_alpha");
    reader.add_event(7, 7, "include", "/chunks/helpers.stan");
    reader.add_event(7, 0, "start", "/chunks/helpers.stan");
    reader.add_event(19, 12, "end", "/chunks/helpers.stan");
    reader.add_event(19, 8, "restart", "model_one_alpha");
    reader.add_event(112, 101, "end", "model_one_alpha");
    return reader;
}
...
#include <meta_header.hpp>
 class model_one_alpha : public prob_grad {
private:
    int n_ts;
    int n_obs;
    vector<int> n_per;
    ...
    vector<double> theta;
public:
    model_one_alpha(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_one_alpha_namespace::model_one_alpha";
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_one_alpha_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_one_alpha_namespace::model_one_alpha stan_model;
