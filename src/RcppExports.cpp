...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_clonewars_sim_clonewars_cpp", (DL_FUNC) &_clonewars_sim_clonewars_cpp, 50},
    {NULL, NULL, 0}
};
