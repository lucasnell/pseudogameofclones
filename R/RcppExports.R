...
#' @export
#'
alate_infect_sims <- function(x_size, y_size, delta_a, delta_p, land, alate, infected, x, y) {
    .Call(`_pseudogameofclones_alate_infect_sims`, x_size, y_size, delta_a, delta_p, land, alate, infected, x, y)
}
